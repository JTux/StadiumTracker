    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Visit", t => t.Visit_VisitID)
                ...
                c => new
                    {
                        ...
                        Park_ParkID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.VisitID)
                .ForeignKey("dbo.Park", t => t.Park_ParkID, cascadeDelete: true)
                .Index(t => t.Park_ParkID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Visit", "Park_ParkID", "dbo.Park");
